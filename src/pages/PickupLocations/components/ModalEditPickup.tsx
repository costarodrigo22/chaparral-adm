...
import useModalEditPickup, { IModalEditPickup } from './useModalEditPickup';

export default function ModalEditPickup({
  id,
  onClose,
  open,
}: IModalEditPickup) {
  const {
    ...
    isPending,
    register,
  } = useModalEditPickup({ id, onClose, open });
      ...
      <DialogContent className="max-h-[90vh] max-w-[90vw] overflow-y-auto overflow-x-auto">
        ...
        <section>
          <form
            ...
            onSubmit={handleSubmit(HandleUpdatePickup)}
          >
            ...
            <div className="w-full justify-end flex">
              <Button disabled={isLoading || isPending}>Atualizar</Button>
            </div>
          </form>
        </section>
      </DialogContent>
